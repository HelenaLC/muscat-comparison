...
- [DS analysis](3-differential.html):
    - Data preparation for `muscat`
    - Aggregation to pseudbulk-counts
    - Pseudobulk-level MDS plot
    - Cluster-level DE analysis
    - Results filtering & overview
    - Cell- & sample-level visualization  
    (violins & heatmaps for cluster-sample mean-expressions)
    - Dimension reduction plots (t-SNE and UMAP)