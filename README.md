...
script      | description 
------------|------------------------------------------------
`prep_X`    | generates a references SCE for simulation (e.g., by keeping samples from one condition only,<br>and unifying relevant cell metadata names to `"cluster_id"`, `"sample_id"`, and `"group_id"`)
